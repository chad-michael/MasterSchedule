...
public class ClsTempLink
{
    public ClsTempLink(string connectionStringName)
    {
    ...
    public void AddRecord()
    {
        ...
        cmd.Parameters.Add("@LinkID", SqlDbType.Int, 4).Direction = ParameterDirection.Output;
        try
        {
            _conn.Open();
            cmd.ExecuteScalar();
            _linkId = (int)cmd.Parameters["@LinkID"].Value;
        }
    ...
    public void DeleteRecord()
    {
        ...
        cmd.Connection = _conn;
        cmd.CommandType = CommandType.StoredProcedure;
        cmd.CommandText = "TempLink_Delete";
        cmd.Parameters.Add("@LinkID", SqlDbType.Int).Value = _linkId;
        try
        {
            _conn.Open();
            cmd.ExecuteScalar();
    ...
    public void GetRecord()
    {
        ...
        cmd.Connection = _conn;
        cmd.CommandType = CommandType.StoredProcedure;
        cmd.CommandText = "TempLink_Get";
        cmd.Parameters.Add("@LinkID", SqlDbType.Int, 4).Value = _linkId;
    ...
    public void UpdateRecord()
    {
        ...
        cmd.Connection = _conn;
        cmd.CommandType = CommandType.StoredProcedure;
        cmd.CommandText = "TempLink_Update";
        cmd.Parameters.Add("@LinkID", SqlDbType.Int, 4).Value = _linkId;
        cmd.Parameters.Add("@Department", SqlDbType.VarChar, 128).Value = _department;
        cmd.Parameters.Add("@Course", SqlDbType.VarChar, 50).Value = _course;
        cmd.Parameters.Add("@Section", SqlDbType.VarChar, 8).Value = _section;
        cmd.Parameters.Add("@Action", SqlDbType.VarChar, 4).Value = _action;
        cmd.Parameters.Add("@SectionID", SqlDbType.UniqueIdentifier, 16).Value = _sectionId;
        try
        {
            _conn.Open();
