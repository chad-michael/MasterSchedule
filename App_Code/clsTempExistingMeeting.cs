...
public class ClsTempExistingMeeting
{
    public ClsTempExistingMeeting(string connectionStringName)
    {
    ...
    public void AddRecord()
    {
        ...
        cmd.CommandText = "TempExistingMeeting_Add";
    ...
    public void DeleteRecord()
    {
        ...
        cmd.Connection = _conn;
        cmd.CommandType = CommandType.StoredProcedure;
        cmd.CommandText = "TempExistingMeeting_Delete";
    ...
    public DataSet FillDs(DataSet ds)
    {
        ...
        cmd.Connection = _conn;
        cmd.CommandType = CommandType.StoredProcedure;
        cmd.CommandText = "TempExistingMeeting_Fill";
        cmd.Parameters.Add("@SectionID", SqlDbType.UniqueIdentifier, 16).Value = _sectionId;
        SqlDataAdapter da = new SqlDataAdapter(cmd);
        try
        {
            da.Fill(ds, "TempExistingMeeting");
        }
        catch (SqlException ex)
        {
            _lastError = ex.Message;
    ...
    public void GetRecord()
    {
        ...
        cmd.Connection = _conn;
        cmd.CommandType = CommandType.StoredProcedure;
        cmd.CommandText = "TempExistingMeeting_Get";
    ...
    public void UpdateRecord()
    {
        ...
        cmd.Connection = _conn;
        cmd.CommandType = CommandType.StoredProcedure;
        cmd.CommandText = "TempExistingMeeting_Update";
        cmd.Parameters.Add("@MeetingID", SqlDbType.Int, 4).Value = _meetingId;
        cmd.Parameters.Add("@Campus", SqlDbType.VarChar, 50).Value = _campus;
        cmd.Parameters.Add("@Room", SqlDbType.VarChar, 50).Value = _room;
        cmd.Parameters.Add("@StartTime", SqlDbType.VarChar, 50).Value = _startTime;
    ...
    public void FlagRecord()
    {
        ...
        cmd.CommandText = "Update TempExistingMeeting set Deleted = 1 where MeetingID =" + _recordId;
        try
        {
            _conn.Open();
            cmd.ExecuteNonQuery();
    ...
    public DataSet FillDsPre()
    {
        DataSet ds = new DataSet();
        return FillDsPre(ds);
    }

    public DataSet FillDsPre(DataSet ds)
    {
        SqlCommand cmd = new SqlCommand();
        cmd.Connection = _conn;
        cmd.CommandType = CommandType.StoredProcedure;
        cmd.CommandText = "TempPreExistingMeeting_Fill";
        cmd.Parameters.Add("@SectionID", SqlDbType.UniqueIdentifier, 16).Value = _sectionId;
        SqlDataAdapter da = new SqlDataAdapter(cmd);
        try
        {
            da.Fill(ds, "TempPreExistingMeeting");
        }
        catch (SqlException ex)
        {
            _lastError = ex.Message;
