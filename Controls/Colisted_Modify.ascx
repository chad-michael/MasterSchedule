<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Colisted_Modify.ascx.cs" Inherits="Controls.Controls_Colisted_Modify" %>
        ...
        <asp:Panel ID="View1" runat="server">
                ...
                <table cellpadding="0" cellspacing="0">
                    <tr>
                        ...
                        <td class="tdvalue">
                            ...
                            <asp:RequiredFieldValidator ValidationGroup="colist" ControlToValidate="rblAction" ID="rfvCoreqAction" runat="server" Display="Dynamic" SetFocusOnError="True" ErrorMessage="Action Type Required.">*</asp:RequiredFieldValidator>
                    ...
                    <tr>
                        ...
                        <td class="tdvalue">
                            ...
                            <asp:RequiredFieldValidator ValidationGroup="colist" ControlToValidate="txtDepartment" ID="rfvCrossDept" runat="server" Display="Dynamic" SetFocusOnError="True" ErrorMessage="Department Required.">*</asp:RequiredFieldValidator>
                    ...
                    <tr>
                        ...
                        <td class="tdvalue">
                            ...
                            <asp:RequiredFieldValidator ValidationGroup="colist" ControlToValidate="txtCatalogNumber" ID="rfvCrossCat" runat="server" Display="Dynamic" SetFocusOnError="True" ErrorMessage="Catalog Number Required.">*</asp:RequiredFieldValidator>
                    ...
                    <tr>
                        ...
                        <td class="tdvalue">
                            ...
                            <asp:RequiredFieldValidator ValidationGroup="colist" ControlToValidate="txtSectionNumber" ID="rfvCrossSect" runat="server" Display="Dynamic" SetFocusOnError="True" ErrorMessage="Section Number Required.">*</asp:RequiredFieldValidator>
                    ...
                    <tr>
                        <td class="tdvalue" colspan="2">
                            <asp:Button ID="btnAdd" runat="server" Text="Update Cross-Listed" OnClick="btnAdd_Click" CausesValidation="true" ValidationGroup="colist" />&nbsp;<asp:Button ID="btnCancel" runat="server" Text="Cancel" OnClick="btnCancel_Click" />
                        </td>
                    </tr>
                </table>
            </div>
            <div style="float: left;">
                        ...
                        <asp:TemplateField>
                            <ItemTemplate>
                                ...
                                <asp:Panel ID="pnlDeleteRecord" runat="server" CssClass="modalwindow" DefaultButton="btnDeleteRecord">
                                    <h2>Confirmation</h2>
                                    <p>Are you sure you want to delete this cross-listed course?</p>
                                    <p>
                                        <asp:Button ID="btnDeleteRecord" runat="server" CausesValidation="false" Text="Yes" CommandName="deletexlink" CommandArgument='<%#Eval("ColinkID") %>' />&nbsp;<asp:Button ID="btnCancelDeleteRecord" runat="server" CausesValidation="false" Text="No" />
                                    </p>
                                </asp:Panel>
                            </ItemTemplate>
                        </asp:TemplateField>
                ...
                <asp:SqlDataSource ID="SqlDataSourceXLink" runat="server" ConnectionString="<%$ ConnectionStrings:MasterSchedule %>"
                    SelectCommand="TempColink_Fill" SelectCommandType="StoredProcedure">
                    <SelectParameters>
