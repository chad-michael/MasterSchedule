<%@ Control Language="C#" EnableTheming="true" AutoEventWireup="true" CodeFile="Faculty.ascx.cs"
    Inherits="Controls.Controls_Faculty" %>
        ...
        <asp:MultiView ID="MultiView1" runat="server">
            ...
            <asp:View ID="View2" runat="server">
                ...
                <table>
                    <tr>
                        <td valign="top">
                            <asp:DropDownList ID="lbFacultyUnassigned" ValidationGroup="addfaculty" runat="server"
                                Width="250px" DataSourceID="SqlDataSourceFacultyUnassigned" DataTextField="FullName"
                                DataValueField="IDNO">
                            </asp:DropDownList>
                            <asp:SqlDataSource ID="SqlDataSourceFacultyUnassigned" runat="server" ConnectionString="<%$ ConnectionStrings:MasterSchedule %>"
                                SelectCommand="List_FacultyUnassigned" SelectCommandType="StoredProcedure"></asp:SqlDataSource>
                        </td>
                        <td valign="top">
                            <div class="multiselectnote">
                                <table>
                                    <tr>
                                        ...
                                        <td valign="top">
                                            <em>Make sure to <strong>Delete</strong> any existing faculty if you need to replace them. </em>
                                        </td>
                                    </tr>
                                </table>
                            </div>
