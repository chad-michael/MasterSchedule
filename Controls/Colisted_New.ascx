<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Colisted_New.ascx.cs" Inherits="Controls.Controls_Colisted_New" %>
                ...
                <table cellpadding="0" cellspacing="0">
                    ...
                    <tr>
                        <td class="tdvalue" colspan="2">
                            <asp:Button ID="btnAdd" runat="server" Text="Add Cross-Listed" OnClick="btnAdd_Click" CausesValidation="false" />&nbsp;<asp:Button ID="btnCancel" runat="server" Text="Cancel" OnClick="btnCancel_Click" />
                        </td>
                    </tr>
                </table>
            </div>
