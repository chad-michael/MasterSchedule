<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Meetings_New.ascx.cs" Inherits="Controls.Controls_Meetings_New" %>
        ...
        <asp:Panel ID="View3" runat="server">
            ...
            <div style="float: left; width: 300px;">
                <table cellpadding="0" cellspacing="0">
                    <tr>
                        <td class="tdkey">Location
                        </td>
                        <td class="tdvalue" colspan="2">
                            <asp:DropDownList ID="ddAddCampus" runat="server" AutoPostBack="True"
                                DataSourceID="SqlDataSourceCampus" DataTextField="CampusCode"
                                DataValueField="CampusesID" ValidationGroup="addmeeting"
                                OnSelectedIndexChanged="ddAddCampus_SelectedIndexChanged">
                            </asp:DropDownList>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <asp:RequiredFieldValidator ValidationGroup="addmeeting" ControlToValidate="MeetingTypeRadioButtonList" ID="RequiredFieldValidator1" runat="server" Display="Dynamic" SetFocusOnError="True" ErrorMessage="Meeting Type Required"></asp:RequiredFieldValidator>
                    ...
                    <tr>
                        <td valign="top" class="multiselectnote">
                            <asp:Image ID="Image2" ImageUrl="~/public/images/information.png" AlternateText="Tip!" ToolTip="Tip!" ImageAlign="AbsMiddle" runat="server" />
                        </td>

                        <td valign="top"><em>Type <strong>A</strong> for AM, or<strong>P</strong> for PM.</em>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td class="tdvalue" colspan="3">
                            <asp:Button ID="btnAddMeeting" runat="server" Text="Add Meeting" OnClick="btnAddMeeting_Click" ValidationGroup="addmeeting" />&nbsp;<asp:Button ID="btnAddCancel" runat="server" Text="Cancel" OnClick="btnAddCancel_Click" ValidationGroup="addmeeting" CausesValidation="false" />
                        </td>
                    </tr>
                </table>
            </div>
            <div style="float: left;">
                <asp:GridView ID="gvMeetings" SkinID="GridView" runat="server" AllowSorting="True" AutoGenerateColumns="False" DataSourceID="SqlDataSourceMeetings" OnRowCommand="gvMeetings_RowCommand">
                    <Columns>
                        <asp:BoundField DataField="Campus" HeaderText="Location" SortExpression="Campus" />
                        ...
                        <asp:TemplateField>
                            <ItemTemplate>
                                ...
                                <asp:Panel ID="pnlDeleteMeeting" runat="server" CssClass="modalwindow" DefaultButton="btnDeleteMeeting">
                                    ...
                                    <p>
                                        <asp:Button ID="btnDeleteMeeting" runat="server" CausesValidation="false" Text="Yes" CommandName="deletemeeting" CommandArgument='<%# Eval("MeetingID") %>' />&nbsp;<asp:Button ID="btnCancelDeleteMeeting" runat="server" CausesValidation="false" Text="No" />
                                    </p>
                                </asp:Panel>
                            </ItemTemplate>
                        </asp:TemplateField>
