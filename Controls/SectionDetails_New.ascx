<%@ Control Language="C#" AutoEventWireup="true" CodeFile="SectionDetails_New.ascx.cs" Inherits="Controls.Controls_SectionDetails_New" %>
        ...
        <table cellpadding="0" cellspacing="0">
            ...
            <tr>
                ...
                <td class="tdvalue">
                    <div>
                        ...
                        <asp:RequiredFieldValidator ValidationGroup="editsection" ID="RequiredFieldValidator4" runat="server" ControlToValidate="txtTermStartDate" ErrorMessage="Course Start Date Required" Display="Dynamic" SetFocusOnError="True">*</asp:RequiredFieldValidator>
            ...
            <tr>
                ...
                <td class="tdvalue">
                    ...
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator5" ValidationGroup="editsection" runat="server" ControlToValidate="txtTermEndDate" ErrorMessage="Course End Date Required" Display="Dynamic" SetFocusOnError="True">*</asp:RequiredFieldValidator>
